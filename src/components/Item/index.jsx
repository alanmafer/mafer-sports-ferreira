...
export default function Item({item}) {  
    ...
    <div className="text-gray-700 relative w-96 p-4 rounded-lg flex flex-col justify-between shadow-lg">
        ...
        <div className="flex justify-between mt-4">
            ...
            <button className="align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-2 px-4 rounded-md shadow-gray-900/10 hover:shadow-gray-900/20 focus:opacity-[0.85] active:opacity-[0.85] active:shadow-none block w-full bg-blue-gray-900/10 text-white shadow-none hover:scale-105 hover:shadow-none focus:scale-105 focus:shadow-none active:scale-100 bg-green-500 ml-6" type="button" onClick={submit}>
